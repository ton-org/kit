...
export const GramIconCircle: FC<IconProps> = ({ size = DEFAULT_ICON_SIZE, ...props }) => (
    <svg
        width={size}
        height={size}
        viewBox="0 0 100 100"
        ...
        {...props}
    >
        <rect width="100" height="100" rx="50" fill="var(--ta-color-gram)" />
        <rect x="0.5" y="0.5" width="99" height="99" rx="49.5" stroke="var(--ta-color-black)" strokeOpacity="0.06" />
        <path
