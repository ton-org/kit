...
export const TransactionRow: React.FC<TransactionRowModel> = ({
    ...
    <Link
        ...
        className="flex items-center gap-3 py-2 -mx-1 px-1 rounded-xl hover:bg-gray-50 transition-colors"
    >
        ...
        <div className="text-right flex-shrink-0">
            <div className={`text-sm font-semibold ${isOutgoing ? 'text-red-500' : 'text-green-500'}`}>{amount}</div>
